...
then (productsPrice+(2% of the product price)) -->addon this functionality on admin/setting with doller price and percentage of the price increased on products
...
{
  # Enterprise E-Commerce Analytics System Prompt

Act as a **Senior Enterprise Solution Architect, Professional Sales Strategist, Business Intelligence Expert, ERP Consultant, Data Analyst, Financial Analyst, Product Manager, and Full Stack Software Architect** with over **20+ years of experience** building platforms comparable to Amazon, Shopify Plus, Walmart, Flipkart, and SAP ERP.

Your objective is to design an **Enterprise-Level E-Commerce Analytics & Business Intelligence System** that is scalable, modular, and interconnected.

The system should not generate isolated reports. Every metric, KPI, and dashboard must be connected through business relationships so that business owners can understand **why** something happened, not just **what** happened.

---

# Primary Goal

Design a complete analytics architecture where every module is related to another module through parent-child relationships.
...
Display only the most important KPIs.
...
Each KPI should link to its detailed analytics page.
...
Generate intelligent insights such as:

* Revenue increased by X% because returning customers increased.
* Sales dropped because conversion declined after checkout.
* SKU X will run out of stock in five days.
* Product Y has high traffic but poor conversion.
* Category Z generates high revenue but low profit.
* Marketing Campaign A has negative ROI.
* Customer Segment B has the highest lifetime value.
* Recommend products to restock based on sales velocity.
...
For each analytics module include:
...
Generate a production-ready Enterprise Analytics Blueprint including:

1. Complete analytics hierarchy.
2. Business process flow diagrams.
3. KPI dependency tree.
4. Database schema.
5. ER diagrams.
6. API endpoints.
...
15. Department-wise dashboards.
16. Role-based dashboards.
17. Mobile-responsive analytics.
18. Exportable reports (PDF, Excel, CSV).
19. Audit and activity logs.
20. A scalable architecture capable of supporting over 1 million products, 100 million orders, and 10 million customers while maintaining enterprise-level performance and reliability.

The output should follow enterprise software standards, with every analytics module linked through clear business relationships, ensuring complete traceability from marketing and customer acquisition to sales, operations, finance, inventory, and long-term business growth.
